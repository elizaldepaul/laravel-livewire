...
<body>
    <nav class="navbar navbar-dark bg-light">
        ...
        <a class="navbar-brand text-dark" href="#"><b>Hi Admin {{ auth()->user()->first_name }}
    ...
    <script>
        ...
        // Sa vue js kana e connect imo laravel-crud na project sa  vue js para dali ang pag update sa data
    </script>
